# Dummy info handler, used for livechart link
...
class InfoHandler(AbstractInfoHandler):
    _show_link_base = "https://livechart.me/anime/{id}/"
    _show_link_matcher = "https?://(?:www\.)?livechart\.me/anime/([0-9]+)"

    def __init__(self):
        super().__init__("livechart", "LiveChart")
